...
async function fetchData() {
  const db = await connect({ host: 'cluster0.3isme4y.mongodb.net' , dbName: 'DataTest1',USER: 'glilamouna',PASS: 'rC0mE7' }); 
  const data = {};
...
async function getTableNames() {
  return (await (await connect({ host: 'cluster0.3isme4y.mongodb.net', port: 27017 , dbName: 'DataTest1',USER: 'glilamouna',PASS: 'rC0mE7' }))
